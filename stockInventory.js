...
// console.log(createBill('johhy', 'Shoes', 7, 0));
// console.log(createBill('John', 'sshoes', 7, 0));
// console.log(createBill('John', 'Shoes', 50, 0));
// console.log(createBill('John', 'Shoes', 7, 9));
